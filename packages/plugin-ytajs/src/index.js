...
export default class ScatterYTA extends Plugin {
    ...
    hookProvider(network){
        return signargs => {
            return new Promise((resolve, reject) => {
                const payload = Object.assign(signargs, { blockchain:Blockchains.YTA, network, requiredFields:{} });
    ...
    signatureProvider(...args){
        ...
        return (network, _yta, _options = {}) => {
            ...
            return proxy(_yta({httpEndpoint:network.fullhost(), chainId, signProvider:proxyProvider}), {
                get(instance, method) {
                    ...
                    return (...args) => {
                        ...
                        prov = async signargs => {
	                        ...
	                        const payload = Object.assign(signargs, { blockchain:Blockchains.YTA, network, requiredFields:requiredFields.requiredFields });
